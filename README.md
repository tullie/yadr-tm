    ...
    sh -c "`curl -fsSL https://raw.githubusercontent.com/tullie/yadr-tm/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/tullie/yadr-tm/master/install.sh`" -s ask
```
